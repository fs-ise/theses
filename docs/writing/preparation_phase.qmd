...
- Use the [Quarto](https://github.com/new?template_name=thesis-template&template_owner=fs-ise){target=_blank} or [Word](https://github.com/fs-ise/theses/raw/refs/heads/main/assets/template.docx){target=_blank} template
- The [analysis templates section](https://fs-ise.github.io/handbook/research/analysis_templates.html){target=_blank}
- Set up a reference manager (like Zotero)
- Create a schedule and work plan
- Read the [evaluation criteria](../criteria.html)
