...
- Create a [repository](https://github.com/new?template_name=thesis-template&template_owner=fs-ise){target=_blank} based on our template or use the [Word template](https://github.com/fs-ise/theses/raw/refs/heads/main/assets/template.docx){target=_blank}
