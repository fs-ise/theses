...
The methods and findings focus more narrowly on the evidence and results of your work.
Afterwards, the discussion should explain how your findings relate to prior research.

![Anatomy of a research paper (Figure by Blair Wang)](https://raw.githubusercontent.com/fs-ise/theses/main/assets/anatomy_research_paper_wang.png){target=_blank}

Note: While creating your thesis, keep the [evaluation criteria](../criteria.html) in mind to ensure your thesis meets the required academic standards.
...
In addition, the purpose of the research study should be clearly defined.
Typically, an abstract consists of around 300 words.
...
The relevance and purpose can further be highlighted by using an appropriate quotation.
...
This gives the reader a clear picture of the composition of the study, i.e., what can and cannot be expected of the study.
...
The literature review should focus on concepts rather than authors and historical development (cf. Webster and Watson, 2002).
...
The methodological approach needs to be described in detail;
appropriate reporting standards for the research method should be considered (such as PRISMA for literature reviews);
...
In this section, the author presents the results of the study. If they are presented by means of figures and/or tables, the results should be clearly legible.
...
In general, the discussion can be divided into three parts. First, the results should be tied to the research question, thus presenting the reader with a solution or improvement to the identified problem space.
...
These suggestions may align with the limitations, as this allows other researchers to build on the present work by extending or analyzing it.
...
A well-crafted conclusion answers the research question stated in the Introduction. By doing so, the author clarifies to what extent the research study has presented a solution or improvement to the examined problem space.
