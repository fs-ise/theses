...
[Learn about the preparation phase](writing/preparation_phase){.btn .btn-lg .btn-success .btn-center target="_blank" rel="noopener"}
...
[Learn about structure and contents](writing/structure_and_contents){.btn .btn-lg .btn-success .btn-center target="_blank" rel="noopener"}
...
[Learn about research](writing/research){.btn .btn-lg .btn-success .btn-center target="_blank" rel="noopener"}
...
[Learn about the writing phase](writing/writing_phase){.btn .btn-lg .btn-success .btn-center target="_blank" rel="noopener"}

## Feedback

You can schedule feedback sessions to discuss your current progress, next steps, and challenges.

[Learn about feedback](writing/feedback){.btn .btn-lg .btn-success .btn-center target="_blank" rel="noopener"}
...
[Learn about the polishing phase](writing/polishing){.btn .btn-lg .btn-success .btn-center target="_blank" rel="noopener"}
