...
[Learn about the preparation phase](writing/preparation_phase.html){.btn .btn-lg .btn-success .btn-center rel="noopener"}
...
[Learn about structure and contents](writing/structure_and_contents.html){.btn .btn-lg .btn-success .btn-center rel="noopener"}
...
[Learn about research](writing/research.html){.btn .btn-lg .btn-success .btn-center rel="noopener"}
...
[Learn about the writing phase](writing/writing_phase.html){.btn .btn-lg .btn-success .btn-center rel="noopener"}

## Feedback

You can schedule feedback sessions to discuss your current progress, next steps, and challenges.

[Learn about feedback](writing/feedback.html){.btn .btn-lg .btn-success .btn-center rel="noopener"}
...
[Learn about the polishing phase](writing/polishing.html){.btn .btn-lg .btn-success .btn-center rel="noopener"}
