...
Your participation helps us [improve the quality of our courses](https://fs-ise.github.io/handbook/teaching/improvements.html){target=_blank} (♻️), and we highly value your opinions.

Thank you for your time and honest feedback!
-->

::: {.callout-note title="Your feedback matters: Help us improve!" collapse=true}
Feedback is important for you as a student and for us as thesis advisors.

As a student, you may write another thesis or seminar paper.
To develop your skills, our goal is to **explain the grading** transparently and to help you understand which parts of your work could be improved and which ones are adequate or excellent.
...
We actively encourage students to participate in feedback sessions.
In the process, we also ask students whether they want to provide feedback, whether we can publish it, and if so, whether it should be published anonymously.

[Provide feedback](https://github.com/fs-ise/theses/edit/main/docs/feedback.qmd){.btn .btn-lg .btn-success .btn-center target="_blank" rel="noopener"}
:::
...
<div class="feedback-rating">★★★★★ <span>5/5</span></div>
...
<div class="feedback-rating">★★★★★ <span>4.9/5</span></div>
...
The supervision of my bachelor's thesis by Prof. Wagner at the Chair of Digital Work was overall very positive. Particularly helpful were the clear structure of the process, the transparent grading criteria, and the regular feedback sessions. Questions were always taken seriously and answered in detail, which gave me a lot of confidence during the work process.

The constructive feedback not only improved the quality of my work but also significantly deepened my understanding of academic work. Overall, I felt very well supported and professionally supervised throughout the entire duration.
:::
...
Meine Erfahrung mit meiner Bachelorarbeit am Lehrstuhl Digital Work war sehr positiv. Zunächst basierte das Thema der Arbeit auf dem Projekt, das ich im vorherigen Semester abgeschlossen hatte. Dadurch fiel mir der Einstieg deutlich leichter und der anfängliche Aufwand, mich in das relevante Themenfeld einzuarbeiten, wurde reduziert.

Prof. Dr. Wagner hat mich von Beginn an sehr unterstützt und mir eine große Menge an relevanten wissenschaftlichen Ressourcen zur Verfügung gestellt. Darüber hinaus war der gesamte Forschungsprozess außergewöhnlich transparent und klar strukturiert: Auf der Webseite des Lehrstuhls wurden die einzelnen Schritte der Abschlussarbeit übersichtlich beschrieben, praxisnahe Hinweise gegeben sowie erwartete Ziele und Kriterien klar benannt. Alle Informationen waren jederzeit online abrufbar. Das hat mir sehr geholfen, den roten Faden zu behalten und die nächsten Schritte selbstbewusst zu planen.

Ein weiterer großer Vorteil war die unkomplizierte Terminvereinbarung über Calendly. Es gab nahezu wöchentlich verfügbare Zeitfenster, sodass ich zeitnah Antworten auf Fragen erhalten konnte. Diese zuverlässige Kommunikationsmöglichkeit und der schnelle, effiziente Austausch waren für meinen Fortschritt entscheidend.

Insgesamt bin ich Prof. Dr. Wagner sehr dankbar für die Betreuung meiner Bachelorarbeit. Es war das erste Mal, dass ich ein Forschungsprojekt in dieser Größenordnung eigenständig durchgeführt habe. Dabei konnte ich wertvolle wissenschaftliche Kompetenzen aufbauen, insbesondere im wissenschaftlichen Schreiben sowie in der Planung und Umsetzung von Experimenten. Diese Erfahrung wird mir für meinen weiteren akademischen und beruflichen Weg sehr helfen und hat mein Verständnis sowie mein Interesse im Bereich Data Analytics deutlich erweitert.
:::
