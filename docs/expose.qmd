...
**Note**: You can use the [template](https://github.com/fs-ise/thesis-template){target=_blank} provided, which outlines the expected structure and format of your exposé.
