...
To start the process, create a repository from the [thesis template repository](https://github.com/fs-ise/thesis-template), give [geritwagner](https://github.com/geritwagner) (read) access, and schedule a meeting to discuss the topic:
...
Bachelor's theses are usually due in 4 months, while master's theses are due in 6 months.
